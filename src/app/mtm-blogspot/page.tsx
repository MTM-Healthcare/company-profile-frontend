...
import { ArrowRight, Star, BookOpen, Zap } from 'lucide-react';
            ...
            <main className="pt-28 pb-24 flex-grow w-full relative z-10">
                ...
                <div className="relative w-full my-4 mb-24">
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div><p className="text-xs text-blue-400 font-bold uppercase tracking-widest mb-1">More Articles</p><h2 className="font-heading font-black text-2xl md:text-3xl text-brand-dark">Latest Health Insights</h2></div>
                        <p className="text-sm text-gray-500 max-w-md leading-relaxed md:text-right">A continuously updated library of articles written and medically reviewed by the MTM Healthcare team.</p>
                    </div>
                </div>
